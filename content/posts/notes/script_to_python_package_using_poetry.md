...
Status: published
Summary: Learn how to convert a simple Python script into a package using Poetry and PyCharm, including setting up the project, configuring dependencies, and publishing it.
ai_summary: true
Tags:
  - python
  - poetry
