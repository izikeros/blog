...
TLDR:
Organize your Data Science project based on Jupyter notebooks in a way that one can navigate through it. Especially that "the one" will be most probably you in few months time. So be nice for yourselves and organize your project in rational structure rather than spontaneous chaos.

## Have you ever had problem with finding valuable work you done in the Jupyter notebook in the past?
...
my_project_name/
  ...
  └── reports
```
Let's look on specific aspects of the cases.
...
## Notebook metadata (can be separate article)
