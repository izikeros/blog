...
autojump is a faster way to navigate your filesystem. It works by maintaining a database of the directories you use the most from the command line. Note that, directories must be visited first before they can be jumped to.
...
On the list[0] there is 300+ projects that are falling into scope of this research, you can get complete dataset by downloading this CSV file: [CSV](180322_results_sorted.csv) or see the full rank in html: [HTML](rank.html)
